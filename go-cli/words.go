...
func registerSDKWords(r *eng.Registry, client *sdk.CataasSDK) {
...
func runOp(client *sdk.CataasSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
