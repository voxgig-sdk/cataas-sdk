# Cataas TypeScript SDK Reference

Complete API reference for the Cataas TypeScript SDK.
...
#### `CataasSDK.test(testopts?, sdkopts?)`
...
**Returns:** `CataasSDK` instance in test mode.
...
Return the parent `CataasSDK` instance.
