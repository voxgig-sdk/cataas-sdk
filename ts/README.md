# Cataas TypeScript SDK



The TypeScript SDK for the Cataas API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.Cat()` — each with a small set of operations (`list`, `load`)
...
| `tester(testopts?, sdkopts?)` | `CataasSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `CataasSDK.test(testopts?, sdkopts?)` | `CataasSDK` | Create a test-mode client. |
...
| `client` | `client(): CataasSDK` | Return the parent SDK client. |
