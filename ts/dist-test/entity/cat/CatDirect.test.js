...
(0, node_test_1.describe)('CatDirect', async () => {
    ...
    (0, node_test_1.afterEach)((0, utility_1.liveDelay)('CATAAS_TEST_LIVE'));
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.CataasSDK({
    ...
    (0, node_test_1.test)('direct-list-cat', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-cat', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function liveScenariosActive() { return false && process.env.CATAAS_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.CataasSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['CATAAS_TEST_CAT_ENTID'];
    ...
    const client = new __1.CataasSDK({
        base: 'http://localhost:8080',
