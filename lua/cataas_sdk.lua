...
CataasSDK._make_feature = _make_feature


function CataasSDK.new(options)
  local self = setmetatable({}, CataasSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function CataasSDK:options_map()
...
function CataasSDK:get_utility()
  return Utility.copy(self._utility)
end


function CataasSDK:get_root_ctx()
  return self._rootctx
end


function CataasSDK:prepare(fetchargs)
...
function CataasSDK:direct(fetchargs)
...
-- by passing it.
function CataasSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function CataasSDK:graphql(query, variables, ctrl)
...
function CataasSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = CataasSDK.new(sdkopts)
  sdk.mode = "test"
