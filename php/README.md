...
The PHP SDK for the Cataas API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Cat(null)->list(null, null);
...
[$result, $err] = $client->Cataas(null)->load(
    ["id" => "test01"], null
);
