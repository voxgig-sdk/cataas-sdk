...
The PHP SDK for the Cataas API — an entity-oriented client using PHP conventions.
...
$cat = $client->Cat()->list();
print_r(array_map(fn($item) => $item->data_get(), $cat));
```
...
The main class (`cataas_sdk.php`) exports the SDK class
