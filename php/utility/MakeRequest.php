...
// Cataas SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class CataasMakeRequest
{
    public static function call(CataasContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new CataasResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new CataasResponse($fetched);
        } else {
