...
// Cataas SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (CataasSDK::test)
...
{
    private const SDK_CLASS = 'CataasSDK';
    ...
    private const SDK_BASE = 'cataas_sdk';
