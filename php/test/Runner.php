...
class CataasTestRunner
{
    ...
    {
        $live = self::getenv('CATAAS_TEST_LIVE');
        $override = self::getenv('CATAAS_TEST_OVERRIDE');
        ...
        $explain = self::getenv('CATAAS_TEST_EXPLAIN');
...
class_alias('CataasTestRunner', 'Runner');
class_alias('CataasHelpers', 'Helpers');
