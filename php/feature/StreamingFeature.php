...
class CataasStreamingFeature extends CataasBaseFeature
{
    ...
    private function _iterate(CataasResult $result): \Generator
    {
    ...
    private function _streamable(CataasContext $ctx): bool
    {
