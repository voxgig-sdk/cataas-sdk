...
class CataasRatelimitFeature extends CataasBaseFeature
{
    ...
    private function _acquire(CataasContext $ctx): void
    {
    ...
    private function _track(CataasContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
