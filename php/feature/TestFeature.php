...
// Cataas SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class CataasTestFeature extends CataasBaseFeature
{
    ...
    public function init(CataasContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (CataasContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (CataasContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(CataasContext $ctx, $op, $args): array
    {
