...
class CataasRbacFeature extends CataasBaseFeature
{
    ...
    private function _required(CataasContext $ctx): ?string
    {
    ...
    private function _reject(CataasContext $ctx, string $required): void
    {
    ...
    private function _track(CataasContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
