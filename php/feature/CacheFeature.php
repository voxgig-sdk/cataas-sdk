...
class CataasCacheFeature extends CataasBaseFeature
{
    ...
    private function _through(CataasContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
