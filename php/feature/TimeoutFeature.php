...
class CataasTimeoutFeature extends CataasBaseFeature
{
    ...
    private function _with_timeout(CataasContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(CataasContext $_ctx, float $ms): void
    {
        $client = $this->client;
