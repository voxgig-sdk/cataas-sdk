...
class TagEntity
  ...
  #
  # @param reqmatch [TagListMatch, Hash, nil] match filter (any subset of Tag fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Tag>, Array] the matching Tag items; raises CataasError on failure
