...
class TagEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set CATAAS_TEST_TAG_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def tag_basic_setup(extra)
  ...
  entid_env_raw = ENV["CATAAS_TEST_TAG_ENTID"]
