...
module CataasTestRunner
  ...
  def self.env_override(m)
    live = getenv("CATAAS_TEST_LIVE")
    override = getenv("CATAAS_TEST_OVERRIDE")
    ...
    explain = getenv("CATAAS_TEST_EXPLAIN")
    m["CATAAS_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = CataasTestRunner
Helpers = CataasHelpers
Vs = VoxgigStruct
