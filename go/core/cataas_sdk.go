...
import (
	...
	vs "github.com/voxgig-sdk/cataas-sdk/go/utility/struct"
)

type CataasSDK struct {
	Mode     string
...
func (sdk *CataasSDK) OptionsMap() map[string]any {
...
func (sdk *CataasSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *CataasSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *CataasSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *CataasSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *CataasSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *CataasSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("CataasSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *CataasSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *CataasSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("CataasSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
