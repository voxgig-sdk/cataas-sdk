# Cataas Golang SDK Reference

Complete API reference for the Cataas Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *CataasSDK`
...
#### `Cat(data map[string]any) CataasEntity`

Create a new `Cat` entity instance. Pass `nil` for no initial data.

#### `Tag(data map[string]any) CataasEntity`
