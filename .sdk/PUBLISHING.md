...
|---|---|---|
| `ts/` | @voxgig-sdk/cataas-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/cataas-sdk \
      --repository voxgig-sdk/cataas-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/cataas-sdk` shows it, and
`npm trust revoke @voxgig-sdk/cataas-sdk --id=<id>` removes it.
