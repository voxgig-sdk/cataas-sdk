...
from projectname_sdk.core.control import CataasControl
...
class CataasContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, CataasResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return CataasError(code, msg, self)
