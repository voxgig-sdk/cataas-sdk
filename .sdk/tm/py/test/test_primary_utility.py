...
from projectname_sdk import CataasSDK
from projectname_sdk.core.spec import CataasSpec
from projectname_sdk.core.result import CataasResult
from projectname_sdk.core.response import CataasResponse
from projectname_sdk.core.operation import CataasOperation
from projectname_sdk.core.error import CataasError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import CataasBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = CataasSDK.test(None, None)
        ...
        class TestInitFeature(CataasBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(CataasBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = CataasSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = CataasSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = CataasSDK.test(None, setup_opts)
