...
class CataasTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = CataasTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = CataasTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = CataasTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
