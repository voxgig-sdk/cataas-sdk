...
class CataasTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = CataasTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = CataasTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = CataasTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
