...
class CataasNetsimFeature extends CataasBaseFeature
{
    ...
    private function _simulate(CataasContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(CataasContext $ctx, array $applied): void
    {
        $client = $this->client;
