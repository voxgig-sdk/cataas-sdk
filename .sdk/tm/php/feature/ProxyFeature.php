...
class CataasProxyFeature extends CataasBaseFeature
{
    ...
    public function init(CataasContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (CataasContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
