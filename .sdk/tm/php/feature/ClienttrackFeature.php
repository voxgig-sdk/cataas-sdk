...
// Cataas SDK clienttrack feature
...
class CataasClienttrackFeature extends CataasBaseFeature
{
    ...
    public function PostConstruct(CataasContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Cataas-SDK';
