...
// Cataas SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = CataasOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(CataasOmni::structfix($now, Struct::undef()))
                        !== json_encode(CataasOmni::structfix($val, Struct::undef()))) {
