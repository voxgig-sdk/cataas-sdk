...
class CataasFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; CataasSDK/1.0)';
    ...
    public static function call(CataasContext $ctx, string $fullurl, array $fetchdef): array
    {
