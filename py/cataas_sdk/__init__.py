...
from cataas_sdk.utility import register

# Load features
from cataas_sdk.feature.base_feature import CataasBaseFeature
from cataas_sdk.features import _has_feature, _make_feature
...
class CataasSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = CataasUtility()
        self._utility = utility

        from cataas_sdk.config import shared_config
    ...
    def get_utility(self):
        return CataasUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("CataasSDK: graphql: " + str(msg))
            res["graphql"] = errors
