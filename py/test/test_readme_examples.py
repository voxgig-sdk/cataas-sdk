# Cataas SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions CataasSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both CataasSDK(...) and CataasSDK.test(...) become
#      CataasSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "cataas_sdk"
_SDK_CLASS = "CataasSDK"
