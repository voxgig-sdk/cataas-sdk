...
type Args struct {
	Entity string         `json:"entity" jsonschema:"cat | tag"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.CataasSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "cataas_list",
		Description: "List records from Cataas. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "cataas_load",
		Description: "Load a single record from Cataas. " +
...
func runOp(client *sdk.CataasSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.CataasSDK, name string) (sdk.CataasEntity, error) {
